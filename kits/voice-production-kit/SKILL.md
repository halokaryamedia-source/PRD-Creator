...
- Flow 6: read `SCRIPT-PRODUCTION.md` and `DOCX-FORMAT.md`; when actual Eleven v3 performance/model/voice/duration/pronunciation guidance matters, enter through `references/elevenlabs/README.md` and open only the relevant supporting page.
...
- `references/elevenlabs/README.md` — evidence-backed ElevenLabs production technique for turning approved Voice meaning into actual generation-ready performance direction.
