...
Use this page for future/non-active work only. It never overrides `../next-action.md`.
...
- [x] real Flow 2→7 proof — The Clockwork Vault;
- [x] real defect → root fix → rebuild/revalidation — DOCX blank-page defect;
