...
| Golden reference remains the exact PRD-core design/runtime artifact; semantic completeness and design grammar are separate owners, and repeatable child cardinality follows project meaning rather than reference-project counts | [adaptive-semantic-composition.md](adaptive-semantic-composition.md), refining [golden-reference-fidelity.md](golden-reference-fidelity.md) |
