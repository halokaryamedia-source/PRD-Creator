...
- `implementation-map.md` — when current product/code/procedure owner is unclear.
...
If the answer is not in the boot context, open the smallest relevant owner next. Do not broad-scan saved projects, all references, generated output, every skill, task board, or old chats by default.
